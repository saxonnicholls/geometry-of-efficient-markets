...
**Paper II.7** — *The Geometry of Efficient Markets*
...
Using the transition density (MARKET_PROCESSES equation 2.3):
...
on the flat torus $[-\pi/2, \pi/2]$ with periodic BC (MARKET_PROCESSES equation 4.7):
