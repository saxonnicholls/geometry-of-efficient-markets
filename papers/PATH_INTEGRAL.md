...
*where $F(b^*) = -\nabla^2 L_T(b^*)|_{b^*}$ is the Hessian of the Kelly growth rate.*

*Proof.* The classical action from $b^*$ to $b^*$ in time $T$ is $S_{\rm cl}(b^*,b^*,T) = 0$
...
KKT conditions for the log-optimal portfolio, equals $-\varepsilon^2\Pi_{NM}\vec{H}/T +
...
*and $F_N = \Pi_{NM}F(b^*)\Pi_{NM}$ is the normal bundle Fisher matrix (idiosyncratic
Fisher information).*
