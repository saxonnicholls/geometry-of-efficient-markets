...
$\beta_{\text{market}}$ encoded by the return history — a $\#\mathbf{P}$-hard computation.*
...
| Figure-eight | $4_1$ | Pseudo-Anosov | $\#\mathbf{P}$ | Count spanning surfaces |
